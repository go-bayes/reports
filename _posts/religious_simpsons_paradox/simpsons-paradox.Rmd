...
m1 <-readRDS(here::here( here::here( "_posts","religious_simpsons_paradox", "models","mnm-simpson-paradox-religious-change.rds" ))

#probability matrix
dt<-  print( round( pmatrix.msm( m1 ) , 2 ) )
...
plotI <-
  ...
  geom_smooth(se = F) +
  scale_y_continuous(limits = c(0, .96))  +
  labs(x = "Age", y = "Annual Probability of Religious (Dis)affiliation w/ 95 CI: range: Pr = 0 to Pr = 1 ") + theme_bw() + labs(title = "Religious (Dis)affiliation Dynamics in New Zealand: years 2009--2020") +
  #scale_colour_manual(values=c( "#E69F00", "#56B4E9")) +
  scale_colour_manual(values = c("#d1495b", "#00798c")) +
  theme(legend.position = "bottom")
plotI
