...
```{r}
 # poisson models require rates to be integers
...
p<-ggpredict(m_church, terms = "ChristianBigDoms")
plot(p, 
     add.data = TRUE,
     dot.alpha =  0.035)

conditional_effects(m_scripture, c("ChristianBigDoms"),
                        prob = c(0.11, 0.89),
                        categorical = F)


conditional_effects(m_prayer, c("ChristianBigDoms"),
                        probs = c(0.11, 0.89),
                        categorical = F)


conditional_effects(m_god, c("ChristianBigDoms"),
                        probs = c(0.11, 0.89),
                        categorical = F)

conditional_effects(m_spirit, c("ChristianBigDoms"),
                        probs = c(0.11, 0.89),
                        categorical = F)


conditional_effects(m_spiritID, c("ChristianBigDoms"),
                        probs = c(0.11, 0.89),
                        categorical = F)


conditional_effects(m_relid, c("ChristianBigDoms"),
                        probs = c(0.11, 0.89),
                        categorical = F)
