...
testfit_plot <- plot(conditional_effects(testfit,  "Wave:As",  ndraws = 500, spaghetti = T), points = F)
...
system.time( testfit2  <- brms::brm_multiple( 
  ...
  data = testdata,
  # c(
  #   prior(normal(0.2,1), class = b, coef = "As1"),
  #   prior(normal(0.05,.1), class = b, coef = "Wave"),
