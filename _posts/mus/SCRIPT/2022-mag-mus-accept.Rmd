...
pl_model_all<- ggeffects::ggemmeans(model_all[[3]], terms = c("Wave","As"))
...
# Same
lazerhawk::brms_SummaryTable(m_prior, panderize=F)
...
lazerhawk::brms_SummaryTable(m_use_pr_sens, panderize=F)
...
marg_eff_attack_0a <- m_prior %>%
 ...
 marg_eff_attack_0a
# #saveRDS(marg_eff_attack_0a,  here::here("_posts", "mus", "mods", "marg_eff_attack_0"))
# marg_eff_attack_0a <- readRDS(here::here("_posts", "mus", "mods", "marg_eff_attack_0a.rds"))
...
outplot<- plot_baseline_constr + plot_baseline_unconstr + plot_annotation(tag_levels = 'a', title = "Bayesian Estimation of Marginal Predictions for Attack Exposure")
outplot
ggsave(
  outplot,
  path = here::here(here::here("_posts", "mus", "figs")),
