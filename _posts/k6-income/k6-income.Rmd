...
This suggests the importance of using, and correctly specifying correct IP weights.
...
m2_lmer <- lmer(
  k6  ~ k6_lag  + bs(inc_l)  + as.numeric(age_c) +
    male + eth +  emp_lag  + nzdep_lag +  urban_lag + (1|Id),
  data = dt_weights_use_2,
...
Here we find support for a linear relationship that is slightly stronger than the GEE estimate (with weights).
